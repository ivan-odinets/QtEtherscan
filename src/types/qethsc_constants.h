...
#ifndef QT_ETHERSCAN_CONSTANTS_H
#define QT_ETHERSCAN_CONSTANTS_H
...
static QLatin1String const   InvalidPriceString = QLatin1String("-1");

static qint64 constexpr      InvalidTimestamp = -1;
static QLatin1String const   InvalidTimestampString = QLatin1String("-1");

static quint32 constexpr     InvalidNodeCount = 0;

static qint32 constexpr      InvalidBlockCount = -1;
static QLatin1String const   InvalidBlockCountString = QLatin1String("-1");

} //namespace QtEtherscan

#endif // QT_ETHERSCAN_CONSTANTS_H
