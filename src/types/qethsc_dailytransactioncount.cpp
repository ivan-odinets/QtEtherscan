...
#include "qethsc_dailytransactioncount.h"
...
DailyTransactionCount::DailyTransactionCount(const QJsonObject& jsonObject) :
    ...
    m_transactionCount  {qint64(jsonObject.value("gasUsed").toDouble())                                           }
{}
